...
class Attendance:
    ...
    ## ================== variaBLES ===================
        ...
        img=img.resize((800,200),Image.ANTIALIAS)   ## ANTIALIAS is used to reduce the quality/size of the image
        ...
        # second image
        img1=Image.open(r"college_images\college.jfif")
        img1=img1.resize((800,200),Image.ANTIALIAS)   ## ANTIALIAS is used to reduce the quality/size of the image
        ...
        img_left=Image.open(r"college_images\left1.jpg")
        ...
        left_inside_frame=Frame(Left_frame,bd=2,relief=RIDGE,bg="white")  ## we want to put frame over the background(so used bg_img),and border=2
        left_inside_frame.place(x=0,y=135,width=720,height=380)  

        ## labels nd entries
        # attendance id
        attendanceID_label=Label(left_inside_frame,text="Attendance ID :",bg="white",font=("times new roman",13,"bold"))
        ...
        # roll
        rollLabel=Label(left_inside_frame,text="Roll :",bg="white",font=("times new roman",13,"bold"))
        ...
        # department
        depLable=Label(left_inside_frame,text="Department :",bg="white",font=("times new roman",13,"bold"))
        ...
        # time
        timeLable=Label(left_inside_frame,text="Time :",bg="white",font=("times new roman",13,"bold"))
        ...
        # date
        dateLable=Label(left_inside_frame,text="Date :",bg="white",font=("times new roman",13,"bold"))
        ...
        #==packing the scroll bar according to its axis
        ...
        ## ====making tables in the right side
        ...
        self.AttendanceReportTable["show"]="headings"  ##to remove extra space from the heading
...
## =======import csv==========
    def importCsv(self):
        ...
        with open(fln) as myfile:
            csvread=csv.reader(myfile,delimiter=",")   ## delimeter is used to separate the values by comma
            for i in csvread:
                mydata.append(i)
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                for i in mydata:
                    exp_write.writerow(i)   ##to append data on new csv
